            ...
            <div className="w-1/2 h-full flex flex-col items-center justify-center">
              <div className="bg-[#01142330] rounded-lg p-3 text-white mb-5">
                ...
                <div className="grid grid-cols-3 grid-rows-2 gap-1">
                  <div
                    className={`col-span-3 col-start-2  border border-[#1E2D3D] rounded-lg w-max py-2.5 px-5 transition-all duration-0  shadow-sm shadow-[#607B96] ${pressed.includes("ArrowUp")
                      ? "scale-105 bg-[#071c2e]"
                      : "bg-[#010C15]"
                      }`}
                  >
                  ...
                  <div
                    className={`border border-[#1E2D3D] rounded-lg w-max py-2.5 px-5 transition-all duration-0  shadow-sm shadow-[#607B96] ${pressed.includes("ArrowLeft")
                      ? "scale-105 bg-[#071c2e]"
                      : "bg-[#010C15]"
                      }`}
                  >
                  ...
                  <div
                    className={`border border-[#1E2D3D] rounded-lg w-max py-2.5 px-5 transition-all duration-0  shadow-sm shadow-[#607B96] ${pressed.includes("ArrowDown")
                      ? "scale-105 bg-[#071c2e]"
                      : "bg-[#010C15]"
                      }`}
                  >
                  ...
                  <div
                    className={`border border-[#1E2D3D] rounded-lg w-max py-2.5 px-5 transition-all duration-0  shadow-sm shadow-[#607B96] ${pressed.includes("ArrowRight")
                      ? "scale-105 bg-[#071c2e]"
                      : "bg-[#010C15]"
                      }`}
                  >
